...
router.get('/chatroom', requireAuth.requireAuth,port.getPort, chatRoomCtl.chatroom_get);
router.get('/chatwithsim', requireAuth.requireAuth,port.getPort, chatRoomCtl.chatwithsim_get);
